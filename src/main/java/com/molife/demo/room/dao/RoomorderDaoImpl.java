...
//		
//		String sql = "SELECT o.roomorder_id ,r.room_name, o.room_check_date ,o.room_total_amount,o.room_order_status "
//				+ "FROM roomorder "
...
//		Map<String, Object> map = new HashMap<>();
//		
//		List<RoomorderVO> memberOrderList = namedParameterJdbcTemplate.query(sql, map, new RoomorderRowMapper());
